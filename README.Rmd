...
from 1990 to 2022 in a tidy format. The data are sourced from the
United Nations Development Programme (UNDP) Human Development Report
2023/2024 Statistical Annex.
...
2022. The data are sourced from the United Nations Development
Programme (UNDP) Human Development Report 2023/2024 Statistical Annex,
...
aggregates from 1990 to 2022. It has `r nrow(worldhdi)` observations and
`r ncol(worldhdi)` variables.
